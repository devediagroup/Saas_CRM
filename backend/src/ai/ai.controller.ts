...
export class AiController {
  ...
  @ApiResponse({
    status: 200,
    description: 'Deal prediction generated successfully',
    type: Object,
  })
  async predictDealOutcome(
    @Param('dealId') dealId: string,
  ): Promise<DealPredictionResult> {
  ...
  @ApiResponse({
    status: 200,
    description: 'Property recommendations generated successfully',
    type: [Object],
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'Lead analytics generated successfully',
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'Performance analytics generated successfully',
  })
